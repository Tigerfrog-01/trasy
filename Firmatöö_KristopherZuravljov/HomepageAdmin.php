...
?>
    ...
    <div id="menyykiht">
        ...
        <a href="<?=$_SERVER['PHP_SELF']?>?lisamine=jah" class="menu-button">Lisa ...</a>
    </div>
    <fieldset id="tooted">
            ...
            if ($kask->fetch()) {
                ...
                ";
                    ...
                    echo "<br /><a href='".$_SERVER["PHP_SELF"].
                        "?kustutusid=$id' class='menu-button'>kustuta</a> ";
                    echo "<a href='".$_SERVER["PHP_SELF"].
                        "?id=$id&amp;muutmine=jah' class='menu-button'>muuda</a>";
                }
            } else {
                echo "Vigased andmed.";
            }
    ...
    <div id="jalusekiht">
        Lehe tegi Kristopher Žuravljov
    </div>
    </body>
    </html>
<?php
